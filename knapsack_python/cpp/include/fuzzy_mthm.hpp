#ifndef FUZZY_MTHM_HPP
#define FUZZY_MTHM_HPP
...
ProfitT fuzzy_mthm_impl(const ProfitT *p, const WeightT *w,
   ...
   * max_balance_iter:  minimum number of improvement trials to run
  ...
  ProfitT z = mkp::mthm_impl(p, w, n, c, m, min_mthm_iter, y_return, NO_GROUP);
